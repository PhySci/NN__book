...
class Network(object):
    ...
    def feedforward(self,a):
         """Return the output of the network if "a" is imput."""
    ...
    def SGD(self,training_data,epochs,mini_batch_size,eta,test_data=None):
        ...
        outputs.  The other non-optional parameters are self-explanatory.  If "test_data" is provided then the
        network will be evaluated against the test data after each epoch, and partial progress printed out.  This is useful for
